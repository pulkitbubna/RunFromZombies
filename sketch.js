...
var gun1,gun2,gun3,gun1Img,gun2Img,gun3Img;
...
gun2Img = loadImage("i1.png");
gun3Img = loadImage("i1.png");
...
gun2 = createSprite(580,130,20,20);
gun2.addImage(gun2Img);
gun2.scale = 0.1

gun3 = createSprite(1075,480,20,20);
...
zombie1 = createSprite(50,650,20,20);
zombie1.addImage(zombie1Img);
zombie1.scale = 0.3

zombie2 = createSprite(2050,50,20,20);
zombie2.addImage(zombie2Img);
zombie2.scale = 0.3

zombie3 = createSprite(2050,350,20,20);
zombie3.addImage(zombie3Img);
zombie3.scale = 0.3

zombie4 = createSprite(2050,650,20,20);
zombie4.addImage(zombie4Img);
zombie4.scale = 0.3

zombie5 = createSprite(1050,650,20,20);
...
if(gamestate === PLAY){
    ...
    zombie1.velocityX = 7;
    zombie1.velocityY = 11;
    zombie2.velocityX = 2;
    zombie2.velocityY = 10;
    zombie3.x = player.x-60;
    zombie4.x = player.x-50;
    zombie4.y = player.y+50;
    zombie5.velocityY = 15;
    ...
    if(!(player.isTouching(gun1))&&!(player.isTouching(gun2))&&!(player.isTouching(gun3))&&!(player.isTouching(knife1))&&!(player.isTouching(knife2))){ 
...
if(player.isTouching(gun2)){
    gun2.x = player.x;
    gun2.y = player.y;
if(gun2.isTouching(zombie1)){
    zombie1.destroy();
    gun2.destroy();
}
if(gun2.isTouching(zombie2)){
    zombie2.destroy();
    gun2.destroy();
}
if(gun2.isTouching(zombie3)){
    zombie3.destroy();
    gun2.destroy();
}
if(gun2.isTouching(zombie4)){
    zombie4.destroy();
    gun2.destroy();
}
if(gun2.isTouching(zombie5)){
    zombie5.destroy();
    gun2.destroy();
}
}

if(player.isTouching(gun3)){
    gun3.x = player.x;
    gun3.y = player.y;
if(gun3.isTouching(zombie1)){
    zombie1.destroy();
    gun3.destroy();
}
if(gun3.isTouching(zombie2)){
    zombie2.destroy();
    gun3.destroy();
}
if(gun3.isTouching(zombie3)){
    zombie3.destroy();
    gun3.destroy();
}
if(gun3.isTouching(zombie4)){
    zombie4.destroy();
    gun3.destroy();
}
if(gun3.isTouching(zombie5)){
    zombie5.destroy();
    gun3.destroy();
}
}

if(player.isTouching(knife1)){
    knife1.x = player.x;
    knife1.y = player.y;
if(knife1.isTouching(zombie1)){
    zombie1.destroy();
    knife1.destroy();
}
if(knife1.isTouching(zombie2)){
    zombie2.destroy();
    knife1.destroy();
}
if(knife1.isTouching(zombie3)){
    zombie3.destroy();
    knife1.destroy();
}
if(knife1.isTouching(zombie4)){
    zombie4.destroy();
    knife1.destroy();
}
if(knife1.isTouching(zombie5)){
    zombie5.destroy();
    knife1.destroy();
}
}

if(player.isTouching(knife2)){
    knife2.x = player.x;
    knife2.y = player.y;
if(knife2.isTouching(zombie1)){
    zombie1.destroy();
    knife2.destroy();
}
if(knife2.isTouching(zombie2)){
    zombie2.destroy();
    knife2.destroy();
}
if(knife2.isTouching(zombie3)){
    zombie3.destroy();
    knife2.destroy();
}
if(knife2.isTouching(zombie4)){
    zombie4.destroy();
    knife2.destroy();
}
if(knife2.isTouching(zombie5)){
    zombie5.destroy();
    knife2.destroy();
}
}

if(player.isTouching(energy1)||player.isTouching(energy2)||player.isTouching(energy3)){
    if(keyDown(DOWN_ARROW)){
...
if(player.isTouching(energy2)){
    energy2.x = player.x;
    energy2.y = player.y;
}
if(player.isTouching(energy3)){
    energy3.x = player.x;
    energy3.y = player.y;
}


if(player.isTouching(energy1)){
   energy1.x = player.x;
   energy1.y = player.y;
 } 
if(energy1.x > 1300||energy1.x < 400||energy1.y < 100 || energy1.y > 900){
   energy1.destroy();
 } 

if(energy2.x > 1700||energy2.x < 2100||energy2.y > 320 || energy2.y < 0){
    energy2.destroy();
}
if(energy3.x > 1500||energy3.x > 2100||energy3.y > 980 || energy3.y < 380){
    energy3.destroy();
}
